/// Custom worker for @ffmpeg/ffmpeg.
/// This file lives in public/ so Turbopack does NOT process it.
/// The dynamic import() below runs at runtime in the browser, bypassing bundler issues.
...
const load = async ({
  ...
  // Dynamic import — runs at runtime in the browser, NOT processed by Turbopack
  const mod = await import(/* webpackIgnore: true */ coreURL);
